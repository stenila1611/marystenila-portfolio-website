...
const certificates = [
  ...
  },
  {
    ...
    icon: "👍",
    title: "Pat on the Back — Esri India",
  ...
  },
  {
    ...
    icon: "👍",
    title: "Pat on the Back — Esri India (OCW)",
  ...
  {
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/13_anna_uni_degree-EJuAAVfaz3gNwNQYfDmdFxQflomO3N.jpg",
    icon: "🏥",
    title: "Life Saver Certificate — First Aid",
    desc: "Certificate for participating in onsite Basic Life Support (First Aid) training — both Theory and Practical — by When-It-Strikes Crisis Management — Oct 2023.",
    isGold: false,
  },
]
    ...
    <section id="awards" className="py-16 sm:py-24 bg-[#0a0f1e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="reveal">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-[#f1f5f9] mb-4 sm:mb-6 text-center lg:text-left" style={{ fontFamily: "var(--font-syne)" }}>
            Online Certifications
          </h3>
